...
globalkeys = gears.table.join(
	...
	-- Screen
    	awful.key({ modkey,       }, "l", function () awful.util.spawn("xscreensaver-command -lock") end,
              {description = "Lock screen: xscreensaver", group = "screen"}),
    -- Layout manipulation
...
awful.rules.rules = {
    ...
    { rule_any = {type = { "normal", "dialog" }
     ...
     -- Guake is always floating so it always lays on the top of the screen above the content
      { rule = { instance = "guake" },
        properties = { floating = true } },
}
-- }}}
